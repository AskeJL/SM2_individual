...
public class GreenhouseGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class GreenhouseActuatorElements extends AbstractParserRuleElementFinder {
		...
		//GreenhouseActuator:
		//	'global' type=[SettingActuator] name=ID 'on' 'controller' controller=[Controller] ('will' action+=Action)? (','
		//	'will' action+=Action)*;
		@Override public ParserRule getRule() { return rule; }
	...
	public class RowActuatorElements extends AbstractParserRuleElementFinder {
		...
		//RowActuator:
		//	type=[SettingActuator] name=ID 'on' 'controller' controller=[Controller] ('will' action+=Action)? (',' 'will'
		//	action+=Action)*;
		@Override public ParserRule getRule() { return rule; }
	...
	public class GreenhouseSensorElements extends AbstractParserRuleElementFinder {
		...
		//GreenhouseSensor:
		//	'global' type=[SettingSensor] name=ID 'on' 'controller' controller=[Controller] 'has' variable=Variable 'and'
		//	'states'
	...
	public class GreenhouseRuleSetElements extends AbstractParserRuleElementFinder {
		...
		//GreenhouseRuleSet:
		//	'global' 'rule' actuator=[GreenhouseActuator] 'set' action=[Action] settingvalue=[SettingValue] 'when'
		//	sensor=[GreenhouseSensor] 'is' state=[State];
		@Override public ParserRule getRule() { return rule; }
